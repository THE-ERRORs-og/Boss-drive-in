...
import { createOrderSummary } from "@/lib/actions/orderSummary"; // Backend action for submission
import { orderSummarySchema } from "@/lib/validation"; // Validation schema for order summary
...
export default function Page() {
  ...
  const [orderData, setOrderData] = useState({
    Napkin: { boh: "", cashOrder: "", inventory: "" },
    Cup: { boh: "", cashOrder: "", inventory: "" },
    Candy: { boh: "", cashOrder: "", inventory: "" },
    Water: { boh: "", cashOrder: "", inventory: "" },
  });
