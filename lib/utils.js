 ...
 */
export function getUSEasternTime(date = new Date()) {
...
/**
 * Formats a date object to "MM/DD/YYYY" forcing UTC timezone.
 * This prevents off-by-one errors when displaying dates stored as Noon UTC.
 * @param {Date} dateObj
