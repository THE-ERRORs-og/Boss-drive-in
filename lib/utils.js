    ...
    <div style="width: 100%; font-size: 20px; background: white; font-family: Arial, sans-serif; padding: 20px;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 10px; border: 1px solid black;">
        <tr style="border: 1px solid black;">
          ...
          <td style="padding: 10px; text-align: right;">$${data.expectedCloseoutCash.toFixed(2)}</td>
        </tr>
        <tr style="border: 1px solid black;">
          <td style="padding: 10px; font-weight: bold;">Starting Register Cash</td>
          <td style="padding: 10px; text-align: right;">$${data.startingRegisterCash.toFixed(2)}</td>
        </tr>
      </table>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 10px; border: 1px solid black;">
        ...
        <tr style="border: 1px solid black;">
          ...
          <td style="padding: 10px; text-align: right;">$${data.onlineTipsToast.toFixed(2)}</td>
        </tr>
        <tr style="border: 1px solid black;">
          <td style="padding: 10px;">Kiosk</td>
          <td style="padding: 10px; text-align: right;">$${data.onlineTipsKiosk.toFixed(2)}</td>
        </tr>
      </table>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 10px; border: 1px solid black;">
        <tr style="border: 1px solid black;">
          ...
          <td style="padding: 10px; text-align: right;">$${data.totalTipDeduction.toFixed(2)}</td>
        </tr>
        <tr style="border: 1px solid black;">
          <td style="padding: 10px; font-weight: bold;">OWED To Restaurant Safe</td>
          <td style="padding: 10px; text-align: right; ${data.ownedToRestaurantSafe < 0 ? 'color: red;' : ''}">
            $${data.ownedToRestaurantSafe.toFixed(2)}
            ${data.ownedToRestaurantSafe < 0 ? '<br><span style="font-size: 14px;">(Reduction from bank safe)</span>' : ''}
          </td>
        </tr>
      </table>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 10px; border: 1px solid black;">
        ...
        <tr style="border: 1px solid black;">
          ...
          <td style="padding: 10px; text-align: right;">$${(data.onlineTipCash || 0).toFixed(2)}</td>
        </tr>
        <tr style="border: 1px solid black;">
          <td style="padding: 10px;">Removal Amount</td>
          <td style="padding: 10px; text-align: right;">$${(data.otherClosingRemovalAmount || 0).toFixed(2)}</td>
        </tr>
        <tr style="border: 1px solid black;">
          <td style="padding: 10px;">Removal Item Count</td>
          <td style="padding: 10px; text-align: right;">${data.otherClosingRemovalItemCount || 0}</td>
        </tr>
        <tr style="border: 1px solid black;">
          <td style="padding: 10px;">Discounts</td>
          <td style="padding: 10px; text-align: right;">$${(data.otherClosingDiscounts || 0).toFixed(2)}</td>
        </tr>
      </table>
    </div>
  `;
