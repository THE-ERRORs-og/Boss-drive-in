  ...
  const htmlContent = `
    <div style="width: 100%; font-size: 20px; background: white; font-family: Arial, sans-serif; padding: 20px;">
      <div style="text-align: center; margin-bottom: 15px;">
        ...
        ${orderDetails.location ? `<p style="margin-top: 10px; text-align: center; background-color: #f0f7ff; padding: 5px; border-radius: 5px;"><strong>Location:</strong> ${orderDetails.location.name}</p>` : ''}
      </div>
